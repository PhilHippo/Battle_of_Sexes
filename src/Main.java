...
public class Main  {
    //ci piace scopare ===> still no bitches tho
        public static void main(String[] args) throws InterruptedException, IOException {
            ...
            Population p = new Population(100,1000,sett);
            ...
            while (counter < 15) {//while there isn't stability or resources aren't finished : resources are calculated and stored
